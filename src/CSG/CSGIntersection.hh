...
#ifndef CSG_INTERSECTION_H
#define CSG_INTERSECTION_H

#include "CSGOperator.hh"

/**
 * This is a CSG intersection operator. It subtracts one object from
 * another.
 */
class CSGIntersection : public CSGOperator 
{
public:
  CSGIntersection(shared_ptr<CSGObject> left, 
